...
class TypeuserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('typeuser')->with('message','Se ha creado correctamente al estudiante');
    }
    ...
    public function destroy($id)
    {
        $typeusers = typeuser::findOrFail($id);
        $typeusers->delete();
        return redirect('typeuser')->with('danger','Se elimino correctamente el estudiante');
    }
